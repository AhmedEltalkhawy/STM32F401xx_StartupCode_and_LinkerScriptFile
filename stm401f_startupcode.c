...
/* 
 * you must do attribute only in declartion 
 * here you add only a section 
 * then you go to linker script file to download them in memory
 */
...
void Reset_Handler(void) __attribute__((section(".isr")))  ;

void Reset_Handler(void)
{
	// reallocate .data from flash to run 
	...
	// initialize .bss in ram with zeroes 
